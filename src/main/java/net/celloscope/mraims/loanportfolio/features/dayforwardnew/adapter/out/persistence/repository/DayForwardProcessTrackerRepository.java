...
public interface DayForwardProcessTrackerRepository extends R2dbcRepository<DayForwardProcessTrackerEntity, String> {
    ...
    @Query("update day_forward_process_tracker set rescheduling_status = :rescheduleStatus where management_process_id = :managementProcessId and samity_id = :samityId")
    ...
    @Query("update day_forward_process_tracker set archiving_status = :archivingStatus where management_process_id = :managementProcessId and office_id = :officeId")
    ...
    @Query("update day_forward_process_tracker set status = :status, process_end_time = :processEndTime where management_process_id = :managementProcessId and samity_id = :samityId")
