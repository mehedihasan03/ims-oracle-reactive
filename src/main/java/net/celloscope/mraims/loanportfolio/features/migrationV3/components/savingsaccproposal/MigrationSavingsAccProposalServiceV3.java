...
@AllArgsConstructor
@Slf4j
public class MigrationSavingsAccProposalServiceV3 {
    private final MigrationSavingsAccProposalRepositoryV3 repository;
...
//                .prematureClosePenalInter(new BigDecimal("500.00"))
                .depositTerm(component.getSavingsProduct().getDepositTerm())
                .depositTermPeriod(component.getSavingsProduct().getDepositTermPeriod())
