...
import net.celloscope.mraims.loanportfolio.features.migration.components.lendingcategory.LendingCategory;
...
import net.celloscope.mraims.loanportfolio.features.migration.components.loanfund.LoanFund;
import net.celloscope.mraims.loanportfolio.features.migration.components.loanproduct.LoanProduct;
import net.celloscope.mraims.loanportfolio.features.migration.components.member.Member;
import net.celloscope.mraims.loanportfolio.features.migration.components.memsmtoffprimap.MemSmtOffPriMap;
import net.celloscope.mraims.loanportfolio.features.migration.components.office.Office;
import net.celloscope.mraims.loanportfolio.features.migration.components.person.Person;
import net.celloscope.mraims.loanportfolio.features.migration.components.samity.Samity;
import net.celloscope.mraims.loanportfolio.features.migration.components.savingsaccount.SavingsAccount;
import net.celloscope.mraims.loanportfolio.features.migration.components.savingsaccproposal.SavingsAccProposal;
import net.celloscope.mraims.loanportfolio.features.migration.components.savingsproduct.SavingsProduct;
import net.celloscope.mraims.loanportfolio.features.migration.components.servicechargechart.ServiceChargeChart;
import net.celloscope.mraims.loanportfolio.features.migration.interestchart.InterestChart;
