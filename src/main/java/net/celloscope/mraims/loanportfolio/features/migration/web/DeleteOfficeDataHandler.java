...
import net.celloscope.mraims.loanportfolio.features.migration.deleteofficedata.DeleteOfficeDataService;
...
@Slf4j
public class DeleteOfficeDataHandler {
    private final DeleteOfficeDataService service;
